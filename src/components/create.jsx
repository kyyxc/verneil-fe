...
const Create = ({ setCreateStatus }) => {
  ...
  return (
    <>
      ...
      {!previewImage && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg w-80 h-96 bg-btn">
      ...
      {previewImage && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-xl w-[750px] h-96 ">
          <div className="h-10 w-full flex items-center justify-center bg-black font-xl font-semibold text-center rounded-t-lg">
            Create Post
          </div>
          <div className="flex h-full">
            ...
            <div className="flex-1 bg-btn p-4 h-full">
              ...
              <form onSubmit={handleCreatePost} className="w-full">
                <textArea name="caption" className="w-full mt-4 h-40 overflow-y-auto overflow-x-hidden outline-none bg-btn text-1 placeholder:text-1 resize-none"></textArea>
